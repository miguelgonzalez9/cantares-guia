...
const SUB_FICHA = {
  es: [
    ...
    { title: 'Mis recorridos', anchor: '.route-chip.hist',
      body: 'El libro guarda lo que has caminado: cada recorrido con su mapa sobre la foto de la reserva, la distancia y el tiempo. Puedes descargarlo como imagen para compartirlo.' },
  ],
  en: [
    ...
    { title: 'My walks', anchor: '.route-chip.hist',
      body: 'The book keeps what you have walked: each route drawn over the reserve photo, with distance and time. You can download it as an image to share.' },
  ],
};
...
const VISITOR = {
  es: [
    ...
    { title: 'El juego: fotografía y suma', anchor: '.tab[data-view="juego"]',
      body: 'Toma una foto de lo que veas y el juego la guarda al instante — aunque no sepas qué es y aunque no haya señal. Después le dices qué es, o te lo dice el identificador. Se juega dentro de la reserva.',
      go: (c) => c.switchView('juego') },
    ...
    { title: 'Reservar y cómo llegar', anchor: '.cm-links',
      body: 'En la pestaña Info están los servicios y tarifas, el enlace de Airbnb, el WhatsApp y las reseñas de quienes ya vinieron.',
  ...
  en: [
    ...
    { title: 'The game: photograph and score', anchor: '.tab[data-view="juego"]',
      body: 'Photograph whatever you see and the game saves it right away — even if you have no idea what it is, even with no signal. You tell it what it is afterwards, or the identifier does. Played inside the reserve.',
      go: (c) => c.switchView('juego') },
    ...
    { title: 'Booking and getting here', anchor: '.cm-links',
      body: 'The Info tab has services and rates, the Airbnb link, WhatsApp and reviews from previous visitors.',
      go: (c) => c.switchView('info') },
...
const GUEST = {
  es: [
    ...
    { title: 'Cuando vengas', anchor: '#route-bar',
      ...
      go: (c) => c.switchView('recorridos') },
    { title: 'Reservar y cómo llegar', anchor: '.cm-links',
      body: 'Servicios y tarifas, el enlace de Airbnb, el WhatsApp y las reseñas de quienes ya vinieron.',
      go: (c) => c.switchView('info') },
    { title: 'Aquí vuelves cuando quieras', anchor: '#help-btn',
  ...
  en: [
    ...
    { title: 'When you visit', anchor: '#route-bar',
      ...
      go: (c) => c.switchView('recorridos') },
    { title: 'Booking and getting here', anchor: '.cm-links',
      body: 'Services and rates, the Airbnb link, WhatsApp and reviews from previous visitors.',
      go: (c) => c.switchView('info') },
    { title: 'Come back any time', anchor: '#help-btn',
  ...
  { id: 'textos', emoji: '✍️', title: 'Los textos de la app', block: 'later', panel: 'closed',
    steps: [
      { title: 'Nuestra historia', anchor: '#hist-edit',
        ...
        go: (c) => c.switchView('restauracion') },
      { title: 'Servicios e Info', anchor: '#cm-edit',
        body: 'En la pestaña Info editas servicios, tarifas, enlaces y reseñas.',
        go: (c) => c.switchView('info') },
    ] },
];
